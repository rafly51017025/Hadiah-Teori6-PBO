...
public abstract class Hadiaht implements ActionListener {
    ...
    {
        label.setText("Moch. Rafly Wisnu Wardana");
        label2.setText("51017025");
        label3.setText("BUMI PERMATA SUDIANG");
    }
